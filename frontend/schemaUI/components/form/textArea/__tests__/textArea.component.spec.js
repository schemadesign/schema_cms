...
import { TextArea, TextAreaComponent } from '../textArea.component';
...
describe('TextArea: Component', () => {
  ...
  const render = (props = {}) => mount(component(props), { disableLifecycleMethods: true });
  ...
  it('should increase height with padding and border after change scrollHeight', () => {
    ...
    const wrapper = mount(<TextAreaComponent {...props} />);
