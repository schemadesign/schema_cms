...
Given('I have entered project details page', () => {
  ...
  expect(browser.getTitle()).to.equal('Project - SchemaCMS');
});
...
Then('I am on project details page', () => {
  ...
  expect(browser.getTitle()).to.equal(
    `${ProjectDetailsPage.Header.subtitle.getText()} - SchemaCMS`
  );
});
...
Then('Project Name is displayed', () => {
  ...
  assert(
    ProjectDetailsPage.Header.subtitle.isDisplayed(),
...
Then('Data Sources tile is displayed', () => {
  ...
  assert(
    ProjectDetailsPage.dataSourcesAmount.isDisplayed(),
    'Data Sources amount is not displayed'
  );
  expect(ProjectDetailsPage.dataSourcesLabel.getText()).to.equal(
    DATA_SOURCES_LABEL
  );
});
...
Then('Users tile is displayed', () => {
  ...
  assert(
    ProjectDetailsPage.usersAmount.isDisplayed(),
