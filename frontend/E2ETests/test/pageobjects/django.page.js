...
import { localDjangoLoginPage } from './../constants/django.constants.js';
import fs from 'fs';
import { ADMIN, EDITOR } from './../constants/login.constants.js';
...
class DjangoPage extends Page {
    ...
    get users() { return $("[href='/admin/users/user/']"); }
    get inviteUserLink() { return $("[href='/admin/users/user/invite-user/']"); }
    get addUser() { return $("[href='/admin/users/user/add/']"); }
    get email() { return $('#id_email'); }
    get firstName() { return $('#id_first_name'); }
    get lastName() { return $('#id_last_name'); }
    get roleDropdown() { return $('#id_role'); }
    get roleAdmin() { return $('[value="admin"]'); }
    get roleEditor() { return $('[value="editor"]'); }
    get saveBtn() { return $('[value="Save"]'); }
    get successMsg() { return $('.success'); }
    get usersListEmail() { return $('tbody > tr:nth-child(1) > td.field-email'); }
    get usersListName() { return $('tbody > tr:nth-child(1) > th > a'); }
    get permissionActive() { return $('#id_is_active'); }
    get userExistsMsg() { return $('.errorlist > li'); }
    get searchInput() { return $('#searchbar'); }
    get userEmail() { return $('#result_list > tbody > tr:nth-child(1) > td.field-email'); }
    get userCheckbox() { return $('tr > td.action-checkbox > input'); }
    get actionsDropdown() { return $('#changelist-form > div.actions > label > select'); }
    get deleteSelectedUsersAction() { return $('[value="delete_selected"]'); }
    get performActionBtn() { return $('[title="Run the selected action"]'); }
    get confirmDeletingUser() { return $('[value="Yes, I\'m sure"]'); }
