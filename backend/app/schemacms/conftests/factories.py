...
pytest_factoryboy.register(project_factories.TagsListFactory, "tags_list")
pytest_factoryboy.register(project_factories.TagFactory, "tag")
pytest_factoryboy.register(project_factories.StateFactory, "state")
