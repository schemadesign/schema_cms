...
pytest_factoryboy.register(pages_factories.BlockTemplateFactory, "page_template")
pytest_factoryboy.register(pages_factories.PageTemplateFactory, "block_template")
