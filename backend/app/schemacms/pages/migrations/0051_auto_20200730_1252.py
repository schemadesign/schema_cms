...
from ..models import PageBlockElement, PageBlock
...
def copy_elements(element: PageBlockElement, block: PageBlock):
    if element.custom_element_set:
        return None

    if element.observable_hq and element.type != "observable_hq":
        return None
