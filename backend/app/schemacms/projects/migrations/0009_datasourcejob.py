# Generated by Django 2.1.9 on 2019-09-18 09:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_state', django_fsm.FSMField(choices=[('pending', 'Pending'), ('in_progress', 'In progress'), ('failed', 'Failed'), ('success', 'Success')], default='draft', max_length=50)),
